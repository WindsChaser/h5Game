...
export default class MenuState extends GameState {
    ...
    set index(value) {
        ...
        this.menuItems.getAt(this.index).frameName = this.menuText[this.index] + "-2.png";
        this._index = value;
        this.menuItems.getAt(this.index).frameName = this.menuText[this.index] + ".png";
        this.game.add.tween(this.menuItems.getAt(this.index)).to({
            x: this.menuItems.getAt(this.index).x + 3,
            y: this.menuItems.getAt(this.index).y + 3
